...
function Sponsors() {
  return (
    <section
      className="relative flex min-h-[35vh] w-full flex-col items-center justify-center overflow-hidden border-y-[0.3rem] border-blue-900/40 bg-black py-10 sm:py-12"
      id="sponsors"
      aria-labelledby="sponsors-heading"
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(34,211,238,0.10),_transparent_55%)]" />

      <div className="relative z-10 mb-8 px-5 text-center">
        <h1
          className="text-4xl font-normal uppercase tracking-wider text-white sm:text-5xl"
          id="sponsors-heading"
          style={{
